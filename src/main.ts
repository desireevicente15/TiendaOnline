...
Chart.register(ArcElement, PieController, DoughnutController, Legend, Tooltip, BarController, CategoryScale, LinearScale, BarElement, LineController, PointElement, LineElement);
